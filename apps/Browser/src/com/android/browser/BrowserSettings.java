...
public class BrowserSettings implements OnSharedPreferenceChangeListener,
    ...
    public String getSearchEngineName() {
    	//String default_engine = mPrefs.getString(PREF_SEARCH_ENGINE, SearchEngine.GOOGLE);
    	String default_engine = mContext.getResources().getString(R.string.default_search_engine_value);
