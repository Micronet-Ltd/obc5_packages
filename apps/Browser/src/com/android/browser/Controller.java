...
public class Controller
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            // -- Main menu
            case R.id.go_home_menu_id:
				Tab curTab = mTabControl.getCurrentTab();
                loadUrl(curTab, mSettings.getHomePage());
                break;
	...
	private void exitAlert(){
		...
		builder.setPositiveButton(R.string.exit_quit, new DialogInterface.OnClickListener() {
		...
		builder.setNegativeButton(R.string.exit_minimize, new DialogInterface.OnClickListener() {
