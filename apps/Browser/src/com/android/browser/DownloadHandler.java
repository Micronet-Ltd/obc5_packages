...
public class DownloadHandler {
    ...
    public static void onDownloadStart(final Activity activity, final String url,
		...
		Log.i(LOGTAG, "onDownloadStart,contentDisposition:" + contentDisposition);
        ...
        if (contentDisposition == null
            ...
            /*added by wenjs to download apk apllication file etc. 20150416 begin*/
            else if ("http".equalsIgnoreCase(scheme) && mimetype.startsWith("application/") &&
                    !mimetype.startsWith("application/x-mpegurl") && !mimetype.startsWith("application/vnd.apple.mpegurl")) {
                new AlertDialog.Builder(activity)
                .setTitle(R.string.application_name)
                .setMessage(R.string.http_video_msg)
                .setPositiveButton(R.string.video_save, new DialogInterface.OnClickListener() {
