        ...
        if (mNumDays > 1) {
            ...
            if (LunarUtils.showLunar() && service != null) {
                ...
                try {
                    ...
                    String mFestival = service.getFestival(year,month, dateNum);
                    String TraditionalFestival = service.getTraditionalFestival(year,month, dateNum);
                        ...
                        display.indexOf(chuxi)>= 0)
                    {
                        ...
                        if (!TextUtils.isEmpty(mFestival) || (isTraditional)) {
                          ...
                          if (display.length() > 3) {
                                ...
                                canvas.drawText(display1, x, y + DAY_HEADER_FONT_SIZE + 2, p);
                                canvas.drawText(display, x, y + DAY_HEADER_FONT_SIZE + 22, p);  
