...
public class SelectCalendarsSimpleAdapter extends BaseAdapter implements ListAdapter,
    ...
    private Context mContext;//added by ao
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //modified by ahp@20150921
        String name = "";
		if(mData[position].ownerAccount.equals(Utils.OWNER_ACCOUNT_LOCAL)){
			name = mContext.getResources().getString(R.string.local_calendar);
		}else{
			name = mData[position].displayName;
		}
		//end ahp
