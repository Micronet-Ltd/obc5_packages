...
public class ContactEditorAccountsChangedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (numAccounts >= 2) {
		 ...
		 /*ehang lihui@20150916 modified for substract local account from accounts list start */	
        } else if (numAccounts == 1 && accounts.get(0).type != AccountWithDataSet.ACCOUNT_TYPE_PHONE) { 
         /*ehang lihui@20150916 modified for substract local account from accounts list end */
