...
public class PeopleActivity extends ContactsActivity implements
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
		...
		makeMenuItemVisible(menu, R.id.menu_cloud, false);  //ehang lihui@20150826 added for remove cloud backup&restore menu
	    makeMenuItemVisible(menu, R.id.menu_scan, false);   //ehang lihui@20150902 added for remove scan menu
