...
public class GroupBrowseListFragment extends Fragment
    ...
    private View mAddGroupsView;     //ehang lihui@20150831 added for add an addGroupsButton instead of  addAccountButton
	private View mAddGroupsButton;   //ehang lihui@20150831 added for add an addGroupsButton instead of  addAccountButton
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mAddAccountsView.setVisibility(View.GONE); //ehang lihui@20150831 added for add an addGroupsButton instead of  addAccountButton
		Log.i(TAG," set addAccountsView View.GONE.");
        mAddAccountButton = mRootView.findViewById(R.id.add_account_button);
		mAddAccountButton.setVisibility(View.GONE);//ehang lihui@20150831 added for add an addGroupsButton instead of  addAccountButton
		Log.i(TAG," set AddAccountButton View.GONE.");
		
        mAddAccountButton.setOnClickListener(new OnClickListener() {
              @Override
              public void onClick(View v) {
                  Log.i(TAG,"AddAccountButton on Click().");
        ...
        /*ehang lihui@20150831 added for add an addGroupsButton instead of  addAccountButton start*/
        final Activity activity = getActivity();
        mAddGroupsView =  mRootView.findViewById(R.id.add_groups);
		mAddGroupsButton = mRootView.findViewById(R.id.add_groups_button);
		mAddGroupsButton.setOnClickListener(new OnClickListener() {
           @Override
           public void onClick(View v) {
               Log.i(TAG,"mAddGroupsButton on Click().");
               Intent intent =  new Intent(activity, GroupEditorActivity.class);
               intent.setAction(Intent.ACTION_INSERT);
               startActivity(intent);			
           }
       });
	   /*ehang lihui@20150831 added for add an addGroupsButton instead of  addAccountButton end*/
       return mRootView;
    }
