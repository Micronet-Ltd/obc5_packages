...
public final class AccountsListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // name.
        if (SimAccountType.ACCOUNT_TYPE.equals(account.type) // || PhoneAccountType.ACCOUNT_TYPE.equals(account.type)  //ehang lihui@20150916 added for display unsynced msg when account is local account
               ) {
            text2.setVisibility(View.GONE);
        } else {
            text2.setVisibility(View.VISIBLE);
        }
		/*ehang lihui@20150916 added for display unsynced msg when account is local account start*/
		if(PhoneAccountType.ACCOUNT_TYPE.equals(account.type)){
            text2.setText(R.string.account_phone);
		} else {
		/*ehang lihui@20150916 added for display unsynced msg when account is local account end*/
