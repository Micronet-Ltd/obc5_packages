...
public class LookupSettingsFragment extends PreferenceFragment
    ...
    private void restoreLookupProviderSwitches() {
		...
		/*lihui @20151013 added for config items control start*/
		int lookup_enable = 0;
        if(getResources().getBoolean(R.bool.config_lookup_settings_enable)){
           lookup_enable = 1;
		}
		/*lihui @20151013 added for config items control end*/
		
        mEnableForwardLookup.setChecked(Settings.System.getInt(cr,
                Settings.System.ENABLE_FORWARD_LOOKUP, lookup_enable) != 0); //lihui @20151013 modified 
        mEnablePeopleLookup.setChecked(Settings.System.getInt(cr,
                Settings.System.ENABLE_PEOPLE_LOOKUP, lookup_enable) != 0); //lihui @20151013 modified 
        mEnableReverseLookup.setChecked(Settings.System.getInt(cr,
                Settings.System.ENABLE_REVERSE_LOOKUP, lookup_enable) != 0); //lihui @20151013 modified 
    }
