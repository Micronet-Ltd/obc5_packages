...
public class VideoSettingsActivity extends ListActivity {
	...
	private static final int STEP_OPTION_15_SECOND = 0;
    private static final int STEP_OPTION_30_SECOND = 1;
    ...
    private int[] getStepOptionIDArray() {
        ...
        stepOptionIDArray[STEP_OPTION_15_SECOND] = R.string.step_option_15_second;
        stepOptionIDArray[STEP_OPTION_30_SECOND] = R.string.step_option_30_second;
        sStepOptionArray  = new int[2];
        sStepOptionArray[0] = STEP_OPTION_15_SECOND;
        sStepOptionArray[1] = STEP_OPTION_30_SECOND;
    ...
    private void restoreStepOptionSettings() {
        ...
        mSelectedStepOption = mPrefs.getInt(SELECTED_STEP_OPTION, STEP_OPTION_15_SECOND);
    }
