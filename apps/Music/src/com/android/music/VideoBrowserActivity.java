...
public class VideoBrowserActivity extends ListActivity implements MusicUtils.Defs
{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, CLOSE, 0, R.string.exit).setIcon(R.drawable.exit_h);
        return true;
    ...
    private void MakeCursor() {
        ...
        if (resolver == null) {
            ...
            if (TextUtils.isEmpty(mFilterString)){
				...
				//where.append(" AND " +  MediaStore.Video.Media.MIME_TYPE + " != 'video/flv' ");
				where.append(" AND " +  MediaStore.Video.Media.MIME_TYPE + " != 'video/x-matroska' ");
            }else{
                //mWhereClause = MediaStore.Video.Media.TITLE + " like '%"+mFilterString+"%'";
                where.append(MediaStore.Video.Media.TITLE + " like '%"+mFilterString+"%' ");
				//where.append(" AND " +  MediaStore.Video.Media.MIME_TYPE + " != 'video/flv' ");
				where.append(" AND " +  MediaStore.Video.Media.MIME_TYPE + " != 'video/x-matroska' ");
            }
