...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    //qj private static final String BUGREPORT_IN_POWER_KEY = "bugreport_in_power";
    ...
    //qj private PreferenceScreen mPassword;
    ...
    public void onCreate(Bundle icicle) {
        ...
        //qj mBugreportInPower = findAndInitSwitchPref(BUGREPORT_IN_POWER_KEY);
    ...
    private void updateAllOptions() {
        ...
        //qj updateSwitchPreference(mBugreportInPower, Settings.Secure.getInt(cr,
...
/* qj
    ...
    private static boolean showEnableOemUnlockPreference() {
        return false;//qj return !SystemProperties.get(PERSISTENT_DATA_BLOCK_PROP).equals("");
    }
...
/*
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } /*qj else if (preference == mBugreportInPower) {
            Settings.Secure.putInt(getActivity().getContentResolver(),
