...
public class LockPatternActivity extends Activity implements OnNotifyAccountReset {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		//add by lyf for disable soft input show when apps->Protected apps 20150828 begin
		getWindow().setSoftInputMode(
                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
	    //add by lyf for disable soft input show when apps->Protected apps 20150828 end
