...
public class PowerUsageSummary extends PreferenceFragment {
	...
	//qj add
    private static final int MENU_BATTERY_SHOWER = Menu.FIRST + 3;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		...
		//qj add
        MenuItem batteryShower = menu.add(0, MENU_BATTERY_SHOWER, 0, R.string.battery_level_switch);
        batteryShower.setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
