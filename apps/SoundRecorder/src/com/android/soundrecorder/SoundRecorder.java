    ...
    public void onClick(View button) {
        ...
        switch (button.getId()) {
            case R.id.recordButton:
                ...
                /*else if (mPath ==1 &&
                ...
                else if (mPath == 1 && getSDState(SoundRecorder.this).equals(Environment.MEDIA_MOUNTED) && !mRemainingTimeCalculator.diskSpaceAvailable() ||
                		mPath == 0 && Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) && !mRemainingTimeCalculator.diskSpaceAvailable()) {
                    mSampleInterrupted = true;
                	...
                	if (mPath ==1 &&
	                    ...
	                    mRemainingTimeCalculator.setStoragePath(mPath);
	                    mRecorder.setStoragePath(mStoragePath);
                        Toast.makeText(SoundRecorder.this, R.string.sd_change_to_local, Toast.LENGTH_SHORT).show();
                    }
                	//modified end
                    stopAudioPlayback();
