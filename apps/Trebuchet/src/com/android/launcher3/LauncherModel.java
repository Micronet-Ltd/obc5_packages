...
public class LauncherModel extends BroadcastReceiver
    ...
    private CharSequence getShortcutTitle(PackageManager manager, Intent intent) {
        ...
        if(b != null){
	        String fso = b.getString("extra_shortcut_fso");
	    	String type = b.getString("extra_shortcut_type");
	    	if(fso != null && type != null  && type.equalsIgnoreCase("navigate")){
	    		return fso.substring(fso.lastIndexOf("/")+1);
	    	}
        }
