...
public class Beidou extends AbstractActivity {

    private static final String TAG = "Beidou Test";
    ...
    void startGPS() {
        ...
        if (!mLocationManager.isProviderEnabled(
            ...
            showToast(getString(R.string.beidou_enable_first));
            final ContentResolver resolver = Beidou.this.getContentResolver();
        ...
        public void onGpsStatusChanged(int arg0) {
            ...
            switch (arg0) {
                case GpsStatus.GPS_EVENT_STARTED:
                    showToast(getString(R.string.beidou_start));
                    break;
