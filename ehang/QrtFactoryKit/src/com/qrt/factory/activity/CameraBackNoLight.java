...
public class CameraBackNoLight extends AbstractActivity
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (0 == msg.what) {
                ...
                if (!isFinishing()) {
                    //Add By zhangkaikai to kill light when test CameraBack SW00080351 2014-09-18 begin 
//                    showPassOrFailDialog(CameraBackNoLight.this,
...
//                            });
    ...
    public void finish() {
        logd("finish");
        mSurfaceHolder.removeCallback(CameraBackNoLight.this);
        stopCamera();
        //Del By Wangwenlong to change flashligth method issue (general) HQ00000000 2013-09-14
        //writeFlashlight(false);
        //mFlashlightPass = false; //Add By zhangkaikai to kill light when test CameraBack SW00080351 2014-09-18  
        super.finish();
    }
    ...
    //    setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE); //delete by bwq set Orientation change to manifest SW00072018 20140902 
    ...
    protected void onResume() {
        ...
        mSurfaceHolder.addCallback(CameraBackNoLight.this);
...
//        takeButton.setVisibility(View.GONE);
        ...
        passButton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                mResultBuffer.append("CameraBack Test  pass"); //Add By zhangkaikai to kill light when test CameraBack SW00080351 2014-09-18 
               //Add By zhangkaikai to kill light when test CameraBack SW00080351 2014-09-18 begin 
//                if (mFlashlightPass) {
                    pass();
//                } else {
//                    fail();
//                }
                    //Add By zhangkaikai to kill light when test CameraBack SW00080351 2014-09-18 end 
            }
        });
