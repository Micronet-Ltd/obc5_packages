...
public class CameraIris extends AbstractActivity
    ...
    private final static String TAG = "CameraIris Test";
    private int mFrontCameraId;

	private boolean mInfrarelightPass;

    @Override
    public void finish() {

        mSurfaceHolder.removeCallback(CameraIris.this);
        stopCamera();
		mInfrarelightPass = false;
        super.finish();
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                if (!isFinishing()) {
                    showPassOrFailDialog(CameraIris.this,
                            getString(R.string.iris_leds_confirm),
                            getString(R.string.yes),
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    mResultBuffer.append("Infrared light Test pass");
                                    mInfrarelightPass = true;
                                }
                            },
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog,
                                        int which) {
                                    mResultBuffer.append("Infrared light Test fail");
                                    mInfrarelightPass = false;
                                }
                            });
                }
...
//        mSurfaceView.setLayoutParams(lp);
        ...
        mSurfaceHolder.addCallback(CameraIris.this);
