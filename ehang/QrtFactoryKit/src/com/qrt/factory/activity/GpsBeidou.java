...
public class GpsBeidou extends AbstractActivity {

    private static final String TAG = "GpsBeidou Test";
    ...
    void startGPS() {
        ...
        if (!mLocationManager.isProviderEnabled(
            ...
            showToast(getString(R.string.gpsbeidou_enable_first));
            final ContentResolver resolver = GpsBeidou.this.getContentResolver();
        ...
        public void onGpsStatusChanged(int arg0) {
            ...
            switch (arg0) {
                case GpsStatus.GPS_EVENT_STARTED:
                    showToast(getString(R.string.gpsbeidou_start));
                    break;
