...
/**
 * Created with IntelliJ IDEA. Owner: wangwenlong Date: 2013.01.06 Time: 16:59
 * To change this template use File | Settings | File Templates.
 */
public class Receiver extends AbstractActivity {

    private static final String TAG = "Receiver Test";
    ...
    private boolean mDefaultSpeakphoneOn = true;       //add by bwq to set speakphoneon when set in_call SW00078531 20140911
    ...
    void play() throws IllegalArgumentException, IllegalStateException,
        ...
        final TextView mTextView = (TextView) findViewById(R.id.receiver_hint);
        ...
        try {
            if (!mMediaPlayer.isPlaying()) {
                ...
                mMediaPlayer.start();
                if (!isFinishing()) {
                    showPassOrFailDialog(Receiver.this,
    ...
    private void setDefaultAudioVolume() {
        ...
        mAudioManager.setSpeakerphoneOn(mDefaultSpeakphoneOn); //add by bwq to set speakphoneon when set in_call SW00078531 20140911
    ...
    private void getDefaultAudioVolume() {
        ...
        mDefaultSpeakphoneOn = mAudioManager.isSpeakerphoneOn();  //add by bwq to set speakphoneon when set in_call SW00078531 20140911
    ...
    public void setAudio() {
        ...
        mAudioManager.setSpeakerphoneOn(false);               //add by bwq to set speakphoneon when set in_call SW00078531 20140911
...
//        playButton = (Button) findViewById(R.id.speaker_play);
        failButton = (Button) findViewById(R.id.receiver_fail);
        final TextView mTextView = (TextView) findViewById(R.id.receiver_hint);
