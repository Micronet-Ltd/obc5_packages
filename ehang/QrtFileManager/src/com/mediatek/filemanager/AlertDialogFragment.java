...
public class AlertDialogFragment extends DialogFragment implements
    ...
    public static class EditTextDialogFragment extends AlertDialogFragment {
        ...
        /**
         * The method is used to set filter to EditText which is used for user entering filename.
            ...
            InputFilter filter = new InputFilter.LengthFilter(maxLength) {
                ...
                public CharSequence filter(CharSequence source, int start, int end, Spanned dest,
                    ...
                    if (source != null && source.length() > 0 && (oldSize + newSize) > maxLength) {
                        LogUtils.v(TAG, "oldSize + newSize) > maxLength");
                        ...
                        LogUtils.w(TAG, "input out of range,hasVibrator:"
                                + hasVibrator);
                        return "";
                    }
    ...
    public static class ChoiceDialogFragment extends AlertDialogFragment {
        ...
        @Override
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            LogUtils.d(TAG, "Show alertSortDialog");
            AlertDialog.Builder builder = createAlertDialogBuilder(savedInstanceState);
	...
	public static class ResultDialogFragmentBuilder extends
			AlertDialogFragmentBuilder {
		@Override
		public ResultDialogFragment create() {
		 ...
		 * @return EditDialogFragmentBuilder
		 */
		public ResultDialogFragmentBuilder setResult(String resulttString) {
			mBundle.putString(ResultDialogFragment.RESULT_STRING, resulttString);			
			return this;
		}
	}
	
    
	public static class ResultDialogFragment extends AlertDialogFragment {
		public static final String TAG = "ResultDialogFragment";
		public static final String RESULT_STRING = "defaultString";		
