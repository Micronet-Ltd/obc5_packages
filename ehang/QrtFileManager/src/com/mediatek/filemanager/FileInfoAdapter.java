...
public class FileInfoAdapter extends BaseAdapter {
	...
	public FileInfo checkEncryptFile() {
        for (FileInfo fileInfo : mFileInfoList) {
			if (fileInfo.isChecked()){
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder = new FileViewHolder((TextView) view
                    .findViewById(R.id.edit_adapter_name), (TextView) view
                    .findViewById(R.id.edit_adapter_size), (ImageView) view
                    .findViewById(R.id.edit_adapter_img), (CheckBox) view
                    .findViewById(R.id.edit_checkbox),
                    (ImageView) view.findViewById(R.id.edit_lock_img));
    ...
    private void setIcon(FileViewHolder viewHolder, FileInfo fileInfo) {
		...
		if (fileInfo.isEncryptFile()) {
            viewHolder.mLock.setImageResource(R.drawable.lock);
        }else{
			viewHolder.mLock.setImageBitmap(null);
        }
    }
    ...
    static class FileViewHolder {
         ...
         */
        public FileViewHolder(TextView name, TextView size, ImageView icon, CheckBox box, ImageView lock) {
            this.mName = name;
            this.mSize = size;
            this.mIcon = icon;
            this.mCheckBox = box;
