...
public final class FileInfoComparator implements Comparator<FileInfo> {
    ...
    private int sortBySize(FileInfo op, FileInfo oq) {
    	/*Modified by yanlei to allow sort by  size  when the file is directory 2014-1-14 begin*/
        if (!op.isDirectory() && !oq.isDirectory()) {//modify by wanli to resolve [SW00039283]
        ...
        /*Modified by yanlei to allow sort by  size  when the file is directory 2014-1-14 end*/
        return sortByName(op, oq);
    }
