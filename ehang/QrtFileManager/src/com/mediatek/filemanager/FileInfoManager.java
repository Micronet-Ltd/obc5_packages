...
public class FileInfoManager {
    public static final String TAG = "FileInfoManager";
    ...
    public void updateFileInfoList(String currentPath, int sortType) {
        LogUtils.d(TAG, "updateFileInfoList");
    ...
    public FileInfo updateOneFileInfoList(String path, int sortType) {
        LogUtils.d(TAG, "updateOneFileInfoList");
    ...
    public void loadFileInfoList(String path, int sortType) {
        LogUtils.d(TAG, "loadFileInfoList");
    ...
    protected void addToNavigationList(NavigationRecord navigationRecord) {
        /*begin delete by wanli to resolve [SW00037953]
        ...
        end delete by wanlli to resolve [SW00037953]*/
        mNavigationList.add(navigationRecord);//add by wanli to resolve [SW00037953]
    }
