...
public class SearchableSource extends AbstractSource {
    ...
    public CharSequence getLabel() {
        /*modifed by zhangjiaquan for SW00022933 show the name follow the language 2013-12-6 begin*/
        if (mActivityInfo != null) {
            // Load label dont lazily
            mLabel = mActivityInfo.loadLabel(getContext().getPackageManager());
        }
           return mLabel;
	  /*modifed by zhangjiaquan for SW00022933 show the name follow the language 2013-12-6 end*/
    }
