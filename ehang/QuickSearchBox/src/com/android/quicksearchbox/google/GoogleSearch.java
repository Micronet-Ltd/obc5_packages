...
public class GoogleSearch extends Activity {
    ...
    private static final String SEARCH_ENGINE_PREF = "search_engine";
    ...
    private Intent createLaunchUriIntentFromSearchIntent(Intent intent) {
        ...
        try {
             /*modified by zhangjiaquan for SW00037849 add choose engine feature 14-3-26 begin*/
             //String searchUri = mSearchDomainHelper.getSearchBaseUrl()
             //       + "&source=android-" + source
             //       + "&q=" + URLEncoder.encode(query, "UTF-8");
            String searchEngine= getSharedPreferences(SEARCH_ENGINE_PREF, Context.MODE_PRIVATE).getString(SEARCH_ENGINE_PREF, this.getResources().getString(R.string.default_engine_value));
            String searchUri = searchEngine+URLEncoder.encode(query, "UTF-8");

             /*modified by zhangjiaquan for SW00037849 add choose engine feature 14-3-26 end*/
            ...
            //del by liulijun to don't set Intent.FLAG_ACTIVITY_NEW_TASK flag (general) SW00065651 2014-7-18
