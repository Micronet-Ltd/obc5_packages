...
public class PreferenceControllerFactory implements PreferenceController {
    ...
    public void handlePreference(Preference p) {
        ...
        } else if (SearchEngineController.SEARCH_ENGINE_PREF_KEY.equals(key)) {
            /*modified by zhangjiaquan for SW00037849 add choose engine feature 14-3-26*/
            addController(new SearchEngineController(mSettings, getContext()), p);
        } else {
