...
public class SearchableItemsActivity extends PreferenceActivity
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        QsbApplication qsbApp = QsbApplication.get(this);
        SearchSettingsImpl searchSettings = (SearchSettingsImpl)qsbApp.getSettings();
        searchSettings.broadcastSettingsChanged();
        return true;
    }
