...
public abstract class SearchActivityView extends RelativeLayout {
    ...
    private static final String ACTIVITY_FOR_RECENTCALLS = "ActivityForRecentCalls"; /*add by liulijun for SW00043882 2014.04.19*/
    ...
    protected void updateQueryTextView(boolean queryEmpty) {
        if (queryEmpty) {
            if (isSearchCorpusWeb()) {
                ...
                Corpus corpus = getCorpus();
                //added by zhangjiaquan for SW00030493 change the prompt when query null 2014-1-17 
                mQueryTextView.setHint(corpus == null ? getResources().getString(R.string.corpus_label_global) : corpus.getHint());
            }
        } else {
    ...
    private void updateSearchGoButton(boolean queryEmpty) {
        if (queryEmpty) {
            ...
            /*modify by liulijun for SW00043882 2014.04.19 begin*/
            if(mCorpus == null || !mCorpus.toString().contains(ACTIVITY_FOR_RECENTCALLS)){
                mSearchGoButton.setVisibility(View.VISIBLE);
            }else{
                mSearchGoButton.setVisibility(View.GONE);
            }
            /*modify by liulijun for SW00043882 2014.04.19 end*/
        }
    }
     ...
     */
     /*deledted by zhangjiaquan for SW00016039 back to activity instead of dismissing the activity 2013-10-17 begin*/
    /*
    @Override
    public boolean dispatchKeyEventPreIme(KeyEvent event) {
     ...
     /*deledted by zhangjiaquan for SW00016039 back to activity instead of dismissing the activity 2013-10-17 end*/
    /**
    ...
    protected boolean isSearchCorpusWeb() {
        //modified by zhangjiaquan for SW00030493 change the prompt when query null 2014-1-17 
    ...
    private class QueryTextEditorActionListener implements OnEditorActionListener {
        public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
            ...
            /*add by liulijun for SW00043882 2014.04.28 begin*/
            if(mCorpus != null && mCorpus.toString().contains(ACTIVITY_FOR_RECENTCALLS)){
                mQueryTextView.hideInputMethod();
                return true;
            }
            /*add by liulijun for SW00043882 2014.04.28 end*/
