...
public class ThemeProvider extends ContentProvider {
    ...
    private static final int THEME_LAUNCHER = 104;//Add By liyichong to add switch theme activity (QL1001) SW00061906 2014-07-01
    ...
    static {
        ...
        mUriMatcher.addURI(ThemeUtils.AUTHORITY, "theme/"+ThemeUtils.URI_THEMELAUNCHER, THEME_LAUNCHER);//Add By liyichong to add switch theme activity (QL1001) SW00061906 2014-07-01
    }
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        case THEME_LAUNCHER: 	
            count = db.update(TABLE_NAME, values, "(" + ThemeUtils.THEME_CATEGORY + " = '" + ThemeUtils.LAUNCHERICON +
                    "') OR (" + ThemeUtils.THEME_CATEGORY + " = '" + ThemeUtils.WALLPAPER + "')", null);
            break;	
