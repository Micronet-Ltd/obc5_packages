...
public class ThemeShowAdapter extends ArrayAdapter<ThemeInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.theme_show_list_item, parent, false);
...
//        FrameLayout themeStatus = (FrameLayout) convertView.findViewById(R.id.theme_preview_icon);
...
//				themeStatus.setBackgroundResource(R.drawable.theme_current_item);
			}else{
