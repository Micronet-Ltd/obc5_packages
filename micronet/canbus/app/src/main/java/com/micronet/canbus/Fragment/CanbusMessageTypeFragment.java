...
public class CanbusMessageTypeFragment extends android.support.v4.app.Fragment {
    ...
    public void onStart() {
        ...
        submit_data = rootView.findViewById(R.id.submitbutton);
        message_type = rootView.findViewById(R.id.editTextType);
        message_id = rootView.findViewById(R.id.editTextId);
        message_data = rootView.findViewById(R.id.editTextData);
