...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    private static final String BUTTON_IMS_ACCOUNT_SETTINGS_KEY ="ims_account_settings_key";  //ehang lihui@20151015 added
    private static final String BUTTON_EMERGENCY_CALL_KEY = "emergency_call_list";            //ehang lihui@20151015 added
	...
	private PreferenceScreen mButtonImsAccountSettings;   //ehang lihui@20151015 added
    private PreferenceScreen mEmergencyCall;             //ehang lihui@20151015 added 
    ...
    protected void onResume() {
        ...
        mButtonImsAccountSettings = (PreferenceScreen) findPreference(BUTTON_IMS_ACCOUNT_SETTINGS_KEY); //ehang lihui@20151015 added.
        ...
        /*ehang lihui@20151015 added for not display IMS account when don't support IMS service start*/
		if(!getResources().getBoolean(R.bool.config_ims_account_settings_enable)){
             Preference pref = prefSet.findPreference(BUTTON_IMS_ACCOUNT_SETTINGS_KEY);
             if (pref != null) {
                 prefSet.removePreference(pref);
             }
		}
        /*ehang lihui@20151015 added for not display IMS account when don't support IMS service end*/
