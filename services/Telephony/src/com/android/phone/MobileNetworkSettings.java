...
public class MobileNetworkSettings extends PreferenceActivity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mButton4glte = (SwitchPreference)prefSet.findPreference(BUTTON_4G_LTE_KEY);

        mButton4glte.setOnPreferenceChangeListener(this);
        mButton4glte.setChecked(ImsManager.isEnhanced4gLteModeSettingEnabledByUser(this));
        /*ehang lihui@20151009 added for whether display mButton4glte depends on if it supports IMS service or VoLTE function start*/
        if(!ImsUtil.isImsEnabled(mPhone.getContext())){
		   log("isImsEnabled= "+ false);
           prefSet.removePreference(mButton4glte);
		}
		/*ehang lihui@20151009 added for whether display mButton4glte depends on if it supports IMS service or VoLTE function end*/
